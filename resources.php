...
<section class="hero" style="padding:var(--sp-3xl) 0;">
    <div class="container">
        <h1>Education Hub</h1>
        <p>Everything you need to understand <?= SITE_NAME ?>: how it works, what the data means, and how to act on it.</p>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="grid grid-3 grid-auto" style="max-width:800px;margin-inline:auto;text-align:center;">
            <div class="stat-card card">
                <div class="stat-value">3 to 6</div>
        ...
        <p class="text-center text-muted mt-lg" style="max-width:600px;margin-inline:auto;">
            Studies show that for every <strong>$1</strong> invested in early warning, <strong>$7 to $23</strong> can be saved in disaster response costs.
        </p>
    </div>
</section>
...
<section class="page-section">
    <div class="container">
        ...
        <div class="card" style="max-width:700px;margin-inline:auto;">
            <p style="line-height:1.8;">The <?= SITE_NAME ?> risk score is a <strong>composite value from 0 to 100</strong>,
            ...
            <div class="table-wrap mt-md">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr><td>Livestock condition</td><td>20%</td><td>NDMA field reports</td></tr>
                        <tr><td>Water access</td><td>15%</td><td>NDMA / community scouts</td></tr>
                        <tr><td>Food security (FCS)</td><td>10%</td><td>NDMA / WFP</td></tr>
            ...
            <p class="mt-md text-muted" style="font-size:var(--fs-sm);">
                A score of <strong>100</strong> means no drought stress; <strong>0</strong> means maximum crisis.
...
<section class="page-section">
    <div class="container">
        <div class="section-header">
            ...
            <p><?= SITE_NAME ?> is unique in combining two complementary knowledge systems.</p>
        </div>
    ...
    <div class="container">
        ...
        <div class="grid grid-3 grid-auto">
            ...
            <div class="card" style="border-top:4px solid var(--clr-primary);">
                <div class="card-header">
                    <div>
                        ...
                        <span class="badge badge-green">Score 80 to 100</span>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card" style="border-top:4px solid var(--clr-warning);">
                <div class="card-header">
                    <div>
                        ...
                        <span class="badge badge-amber">Score 60 to 79</span>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <ul style="list-style:none;font-size:var(--fs-sm);line-height:2.2;color:var(--clr-text);">
                        ...
                        <li>Reduce herd size by 20 to 30% if pasture is poor</li>
            ...
            <div class="card" style="border-top:4px solid var(--clr-danger);">
                <div class="card-header">
                    <div>
                        <h3 class="card-title" style="color:var(--clr-danger);">High Risk: Alarm and Emergency</h3>
                        <span class="badge badge-red">Score 0 to 59</span>
                    </div>
                </div>
                <div class="card-body">
